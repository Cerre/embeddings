...
def process_csv_row(row):
    ...
    lines = [line for line in lines if re.match(r'\d{1,2}:\d{2}', line.split(' ', 1)[0])]
...
# Load the CSV file
input_csv_filename = "cleaned_data/combined_transcripts.csv"  # Change this to your input CSV file path
