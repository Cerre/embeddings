...
query_embedding_np = np.array([query_embedding])  # Needs to be reshaped for a single query
...
nearest_info = [(video_ids[idx], text_chunks_info[idx][0], text_chunks_info[idx][1]) for idx in indices[0]]
